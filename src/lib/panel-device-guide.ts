...
export const panelGuideDisclaimer =
  "Щитток показывает, какие приборы видны на фото и в схеме. Сервис не проверяет, правильно ли они соединены между собой, подобраны ли номиналы и исправно ли всё работает на самом деле. Окончательную оценку может дать только очный осмотр электрика.";
