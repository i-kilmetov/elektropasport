...
/** 10% off master call services while Plus is active. */
export const TOKOM_PLUS_MASTER_DISCOUNT = 0.1;
...
export const PANEL_LIMIT_MESSAGE_FREE =
  "Без подписки можно добавить до 3 щитков. Подключите Током Плюс — и лимитов не будет.";
