...
export const deviceSpecGuide: Record<RailDeviceType, DeviceSpecGuide> = {
  ...
  contactor: {
    title: "Модульный контактор",
    intro:
      "Силовой коммутатор с катушкой: включает нагрузку по сигналу автоматики, а не рычагом автомата.",
    fields: [
      {
        key: "Полюса",
        options: ["1P", "2P", "3P", "4P"],
        howToPick:
          "Сколько силовых полюсов нужно разомкнуть/замкнуть. Для однофазной нагрузки часто 1P или 2P, для трёхфазной — 3P/4P.",
      },
      {
        key: "Номинальный ток",
        options: ["16 A", "25 A", "40 A", "63 A"],
        howToPick:
          "Не меньше рабочего тока нагрузки. Перед контактором обычно стоит автомат защиты.",
      },
      {
        key: "Катушка",
        options: ["230 V AC", "24 V AC", "24 V DC"],
        howToPick:
          "Напряжение цепи управления (A1/A2). В бытовых щитах чаще всего 230 V AC.",
      },
    ],
    footnote:
      "Контактор не заменяет автомат защиты — он только коммутирует цепь по команде.",
  },
  socket: {
    title: "Розетка на DIN",
    intro:
      "Щитовая розетка для сервиса или временной нагрузки. Должна быть защищена автоматом и желательно УЗО.",
    fields: [
      {
        key: "Полюса",
        options: ["1P+N", "2P"],
        howToPick: "Обычно 1P+N под 230 В с заземляющим контактом на корпусе/клемме PE.",
      },
      {
        key: "Номинальный ток",
        options: ["10 A", "16 A"],
        howToPick: "Чаще 16 A — как у обычной силовой розетки.",
      },
    ],
    footnote:
      "Не используйте щитовую розетку как постоянную «домашнюю» без защиты УЗО.",
  },
};
