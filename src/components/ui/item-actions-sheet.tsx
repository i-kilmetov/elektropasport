    ...
    <Portal>
      ...
      >
        <motion.div
          ...
          className="mx-auto w-full max-w-md rounded-t-[28px] border border-black/8 bg-white p-5 pb-[max(1.5rem,env(safe-area-inset-bottom))] shadow-2xl lg:rounded-[28px]"
        >
