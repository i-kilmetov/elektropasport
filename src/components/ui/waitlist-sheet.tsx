...
> = {
  ...
  terminals: {
    ...
    body: [
      "Сейчас разводка кабелей по клеммам доступна только мастерам.",
      "Мы готовим этот режим для всех пользователей — чтобы каждый мог аккуратно нарисовать связи на схеме своего щитка.",
      "Оставьте почту — напишем, как только функция станет доступна всем.",
    ],
    emailHint: "Куда сообщить о доступе",
  },
};
