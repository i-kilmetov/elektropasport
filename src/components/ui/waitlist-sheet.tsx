...
> = {
  school: {
    title: "Школа Током",
    body: [
      "Скоро откроем курсы, где электрика объясняется по-человечески — с примерами из дома, а не только со схем в учебнике.",
      "Разберём щиток, защиту, линии и безопасность так, чтобы это осталось в голове, а не «пролистал и забыл».",
      "Оставьте почту — напишем о старте школы и иногда пришлём самое любопытное про электрику и сервис, не чаще раза в месяц.",
    ],
