...
const panelPoints = [
  {
    icon: Zap,
    text: "Без подписки можно добавить до 3 щитков и до 10 видов техники к каждому.",
  },
  {
    icon: Infinity,
    text: "Током Плюс — заряженная подписка: безлимит, клеммы и скидка 10% на вызов мастера.",
  },
  {
    icon: Heart,
