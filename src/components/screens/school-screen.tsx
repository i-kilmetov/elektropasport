  ...
  return (
    ...
    >
      ...
      <div className="space-y-5">
        <p className="ty-body">
          В Школе Током электрика — без скучных формул ради формул. Разбираем,
          как устроен дом: от розетки и линии до щитка, чтобы вы понимали, что
          происходит, а не просто «так сказал мастер».
        </p>

        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/empty-states/school.png"
          alt="Доска Школы Током: ток, вольт, ампер — ТОКОМ"
          width={784}
          height={496}
          draggable={false}
        ...
        <div>
          <p className="ty-body">
            Короткие уроки, живые примеры и схемы — плюс экзамен с оценкой.
            Программа подстраивается под ваши щитки и технику в Током. Классы
            открываются по порядку: сдали один — открыли следующий. Продлёнка
            ждёт после первого класса.
          </p>
          {finished > 0 ? (
