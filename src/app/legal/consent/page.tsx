      ...
      <LegalSection title="Текст согласия">
        ...
        <ul className="list-disc space-y-1 pl-5">
          <li>
            ...
            имя, телефон, e-mail, адрес объекта, данные об электрическом
            щитке и заявках, технические данные сессии.
          </li>
          <li>
          ...
          <li>
            ...
            сервисы адресов — в необходимом объёме), обезличивание, удаление.
          </li>
          <li>
