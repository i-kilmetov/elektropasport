...
export default function MoscowStatusPage() {
  ...
  return (
    <main className="mx-auto min-h-[100dvh] max-w-xl bg-white px-5 py-8 text-zinc-900">
      <h1 className="ty-title">Проверка data.mos.ru</h1>
      ...
      {clientProbe && (
        <p className="mt-4 rounded-[14px] border border-black/8 bg-zinc-50 px-3 py-2 ty-note">
      ...
      {loading ? (
        <p className="mt-6 ty-body">Проверяем…</p>
      ) : (
        <pre className="mt-6 overflow-x-auto rounded-[16px] border border-black/8 bg-zinc-50 p-4 ty-meta whitespace-pre-wrap">
