...
- contactor — модульный контактор (КМ): корпус с катушкой/маркировкой A1 A2, часто без классической кривой C/B/D автомата; подписи «контактор», КМ, Contactor
- socket — модульная щитовая розетка на DIN (Schuko/евророзетка в узком корпусе 1 модуль)
- pe_bus — PE-шина
- n_bus — N-шина

### contactor vs breaker
Контактор: надписи A1/A2, KM, «контактор», иногда кнопка/индикатор катушки; НЕТ кривой отключения C16 как у АВ.
Автомат: рычаг + кривая C/B/D + ток (C16…).

### socket
Узкий 1-модульный корпус с отверстиями розетки / шторками. Не путай с УЗИП.
